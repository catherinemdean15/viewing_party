...
RSpec.describe 'dashboard index' do
  before :each do
    ...
    @party_1 = Party.create!(start_time: 'beginning time', end_time: 'ending_time')
    @party_2 = Party.create!(start_time: 'beginning time', end_time: 'ending_time')
    @movie_1 = @party_1.movies.create!(title: 'Mulan', run_time: '1 hour 12 min', genre: 'Family')
    @movie_2 = @party_2.movies.create!(title: 'Oceans 11', run_time: '2 hours 10 min', genre: 'Action')
